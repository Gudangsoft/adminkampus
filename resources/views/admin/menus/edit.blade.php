...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('admin.menus.show', $menu) }}" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm">
    ...
    <div class="row">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.menus.update', $menu) }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="link_type" 
                                               id="link_type_url" value="url" 
                                               {{ ($menu->url && !$menu->page_id) ? 'checked' : '' }}>
                        ...
                        <div class="form-group mb-3" id="url_field" style="{{ $menu->page_id ? 'display: none;' : '' }}">
                        ...
                        <div class="form-group mb-3" id="page_field" style="{{ !$menu->page_id ? 'display: none;' : '' }}">
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input @error('is_active') is-invalid @enderror" 
                               ...
                               {{ old('is_active', $menu->is_active) ? 'checked' : '' }} form="menuForm">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <p><strong>Dibuat:</strong><br>{{ $menu->created_at->format('d M Y H:i') }}</p>
                    <p><strong>Terakhir Update:</strong><br>{{ $menu->updated_at->format('d M Y H:i') }}</p>
                    
                    @if($menu->children->count() > 0)
                        <p><strong>Submenu:</strong><br>{{ $menu->children->count() }} item</p>
                        <ul class="small">
                    ...
                    @if($menu->parent)
                        <p><strong>Parent Menu:</strong><br>{{ $menu->parent->name }}</p>
                    @endif
                </div>
            </div>
        </div>
