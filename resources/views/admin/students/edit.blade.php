            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="ri-user-settings-line me-2"></i>Form Edit Mahasiswa - {{ $student->name }}
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.students.update', $student) }}" method="POST" enctype="multipart/form-data" id="studentForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control @error('place_of_birth') is-invalid @enderror" 
                                                       id="place_of_birth" name="place_of_birth" value="{{ old('place_of_birth', $student->place_of_birth) }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select @error('entry_year') is-invalid @enderror" 
                                                    ...
                                                    @for($year = date('Y'); $year >= 2000; $year--)
                                                        <option value="{{ $year }}" 
                                                                {{ old('entry_year', $student->entry_year) == $year ? 'selected' : '' }}>
                                                            {{ $year }}
                                                        </option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control @error('school_origin') is-invalid @enderror" 
                                                       id="school_origin" name="school_origin" value="{{ old('school_origin', $student->school_origin) }}">
                                                @error('school_origin')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select @error('semester') is-invalid @enderror" 
                                                    ...
                                                    @for($sem = 1; $sem <= 14; $sem++)
                                                        <option value="{{ $sem }}" 
                                                                {{ old('semester', $student->semester) == $sem ? 'selected' : '' }}>
                                                            Semester {{ $sem }}
                                                        </option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" max="4" 
                                                       ...
                                                       id="gpa" name="gpa" value="{{ old('gpa', $student->gpa) }}">
                                                @error('gpa')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" min="0" max="160" 
                                                       ...
                                                       id="credits_taken" name="credits_taken" value="{{ old('credits_taken', $student->credits_taken) }}">
                                                @error('credits_taken')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="date" class="form-control @error('graduation_date') is-invalid @enderror" 
                                                       id="graduation_date" name="graduation_date" value="{{ old('graduation_date', $student->graduation_date?->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="card-body text-center">
                                        <div class="mb-3">
                                            <div id="photoPreview" class="mx-auto mb-3" 
                                                ...
                                                @else
                                                    <img src="{{ $student->photo_url }}" alt="Default Avatar" 
                                                         style="width: 100%; height: 100%; object-fit: cover; border-radius: 6px;">
                                                @endif
                                            </div>
                                            ...
                                            @if($student->photo)
                                                <div class="mt-2">
                                                    <small class="text-success">Foto saat ini: {{ basename($student->photo) }}</small>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="card-title mb-0">Informasi Registrasi</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-2">
                                            <small class="text-muted">Dibuat:</small><br>
                                            <span class="text-dark">{{ $student->created_at?->format('d M Y H:i') }}</span>
                                        </div>
                                        <div class="mb-2">
                                            <small class="text-muted">Terakhir Diupdate:</small><br>
                                            <span class="text-dark">{{ $student->updated_at?->format('d M Y H:i') }}</span>
                                        </div>
                                        @if($student->studyProgram)
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <span class="text-dark">{{ $student->studyProgram->faculty->name }}</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-grid gap-2">
                                            <button type="submit" class="btn btn-primary">
                                                <i class="ri-save-line me-2"></i>Update Mahasiswa
                                            </button>
