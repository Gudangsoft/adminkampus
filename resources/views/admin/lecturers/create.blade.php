    ...
    <div class="row">
                                ...
                                <select class="form-select @error('study_program_ids') is-invalid @enderror" 
                                    ...
                                    @foreach($studyPrograms as $program)
                                        <option value="{{ $program->id }}" 
                                                {{ in_array($program->id, old('study_program_ids', [])) ? 'selected' : '' }}>
                                            {{ $program->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('expertise') is-invalid @enderror" 
                                          ...
                                          name="expertise" 
                                          rows="3"
                                          placeholder="Bidang keahlian yang dikuasai">{{ old('expertise') }}</textarea>
                                @error('expertise')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('structural_position') is-invalid @enderror" 
                                    ...
                                    @foreach($structuralPositions as $key => $position)
                                        <option value="{{ $key }}" 
                                                {{ old('structural_position') == $key ? 'selected' : '' }}>
                                            {{ $position }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('structural_description') is-invalid @enderror" 
                                          ...
                                          rows="3"
                                          placeholder="Deskripsi tugas dan tanggung jawab">{{ old('structural_description') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('structural_start_date') }}">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm">
                <div class="card-header bg-warning text-dark">
                    <h6 class="mb-0"><i class="fas fa-info-circle me-2"></i>Petunjuk Pengisian</h6>
                </div>
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2">
                            <i class="fas fa-check text-success me-2"></i>
                            NIDN wajib diisi dan unik
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check text-success me-2"></i>
                            Pilih fakultas sesuai dengan bidang dosen
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check text-success me-2"></i>
                            Program studi bersifat opsional, bisa multiple
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check text-success me-2"></i>
                            Foto profil akan digunakan di website
                        </li>
                        <li class="mb-0">
                            <i class="fas fa-check text-success me-2"></i>
                            Status aktif menentukan tampilan di website
                        </li>
                    </ul>
                </div>
            </div>
